...
def main():
    if SPREADSHEET_URL == "https://docs.google.com/spreadsheets/d/XXXXXXXXXX/edit":
        print("[!] Bạn hãy điền đường link Google Sheet của bạn vào biến SPREADSHEET_URL ở dòng thứ 9.")
        return
    ...
    all_data += scrape_dmx("https://www.dienmayxanh.com/may-lanh-lg")
    all_data += scrape_dmcl("https://dienmaycholon.com/may-lanh-lg")
    all_data += scrape_nk("https://www.nguyenkim.com/may-lanh-lg")
    all_data += scrape_cps("https://cellphones.com.vn/may-lanh/lg.html")
    all_data += scrape_fpt("https://fptshop.com.vn/may-lanh-dieu-hoa/lg")
    all_data += scrape_mediamart("https://mediamart.vn/dieu-hoa-nhiet-do-lg")
    all_data += scrape_hc("https://hc.com.vn/ords/cat/dieu-hoa/lg")
